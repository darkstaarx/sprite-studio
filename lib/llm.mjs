...
function localPosts(brief, platforms, n) {
  ...
  for (let i = 0; i < n; i++) {
    ...
    if (p === "threads") {
      const t = threadShapes[i % threadShapes.length]();
