...
export const ANGLES = {
  ...
  "lawak":          { label: "Cerita lawak", shape: "Satu babak sebenar dengan kau sebagai bahan (bila, kat mana, siapa nampak) → apa yang jadi, tanpa terangkan produk → tutup dengan akibat kecil yang masih berlaku sampai sekarang. Jangan buka dengan pepatah, jangan letak teka-teki, jangan terangkan jenaka sendiri." },
